 ...
 * @access Manager
 */
export const updateStaffStatus = asyncHandler(async (req, res, next) => {
  const { staffId } = req.params;
 ...
 * @access Manager
 */
export const updateStaffPerformance = asyncHandler(async (req, res, next) => {
  const { staffId } = req.params;
 ...
 * @access Manager
 */
export const addStaffTraining = asyncHandler(async (req, res, next) => {
  const { staffId } = req.params;
 ...
 * @access Manager
 */
export const getStaffSchedule = asyncHandler(async (req, res, next) => {
  const { staffId } = req.params;
  const managerBranch = req.user.branch;
 ...
 * @access Manager
 */
export const updateStaffSchedule = asyncHandler(async (req, res, next) => {
  const { staffId } = req.params;
