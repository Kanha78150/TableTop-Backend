 ...
 * @access  Private (Admin)
 */
export const createCoinSettings = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin)
 */
export const updateCoinSettings = asyncHandler(async (req, res, next) => {
  const adminId = req.admin._id;
 ...
 * @access  Private (Admin)
 */
export const getCoinAnalytics = asyncHandler(async (req, res, next) => {
  const adminId = req.admin._id;
 ...
 * @access  Private (Admin)
 */
export const makeManualCoinAdjustment = asyncHandler(async (req, res, next) => {
  // Validate request body
 ...
 * @access  Private (Admin)
 */
export const getUsersWithCoins = asyncHandler(async (req, res) => {
  const adminId = req.admin._id;
  const {
    page = 1,
    limit = 20,
 ...
 * @access  Private (Admin)
 */
export const getCoinTransactionHistory = asyncHandler(async (req, res, next) => {
  const adminId = req.admin._id;
  const {
    page = 1,
    limit = 20,
 ...
 * @access  Private (Admin)
 */
export const getCoinSettingsHistory = asyncHandler(async (req, res, next) => {
  const adminId = req.admin._id;
  const settings = await coinService.getCoinSettings(adminId);
 ...
 * @access  Private (Admin)
 */
export const reverseCoinTransaction = asyncHandler(async (req, res, next) => {
  const adminId = req.admin._id;
