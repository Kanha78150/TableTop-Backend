 ...
 */
export const generateTableQRCodes = asyncHandler(async (req, res, next) => {
  const {
    hotel,
    branch,
    totalTables,
 ...
 */
export const regenerateTableQR = asyncHandler(async (req, res, next) => {
  const { tableId } = req.params;
 ...
 */
export const bulkUpdateTableStatus = asyncHandler(async (req, res, next) => {
 ...
 */
export const getTableStats = asyncHandler(async (req, res, next) => {
