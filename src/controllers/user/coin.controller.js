 ...
 * @access  Private (User)
 */
export const getCoinDetails = asyncHandler(async (req, res, next) => {
  const userId = req.user._id;
 ...
 * @access  Private (User)
 */
export const getCoinHistory = asyncHandler(async (req, res, next) => {
  const userId = req.user._id;
 ...
 * @access  Private (User)
 */
export const calculateCoinDiscount = asyncHandler(async (req, res, next) => {
  const userId = req.user._id;
 ...
 * @access  Private (User)
 */
export const getMaxCoinsUsable = asyncHandler(async (req, res, next) => {
  const userId = req.user._id;
 ...
 * @access  Private (User)
 */
export const calculateCoinsEarning = asyncHandler(async (req, res, next) => {
  const { orderValue, hotelId, branchId } = req.query;
 ...
 * @access  Private (User)
 */
export const getCoinSystemInfo = asyncHandler(async (req, res, next) => {
