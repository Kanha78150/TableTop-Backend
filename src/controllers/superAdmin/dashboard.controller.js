 ...
 */
export const getAllAdminsWithDetails = async (req, res, next) => {
  try {
 ...
 */
export const getAdminCompleteDetails = async (req, res, next) => {
  try {
 ...
 */
export const getAllHotelsWithAdmins = async (req, res, next) => {
  try {
    // Parse query parameters
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
 ...
 */
export const getAllBranchesWithDetails = async (req, res, next) => {
  try {
    // Parse query parameters
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
 ...
 */
export const getAllManagersWithDetails = async (req, res, next) => {
  try {
    // Parse query parameters
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
 ...
 */
export const getAllStaffWithDetails = async (req, res, next) => {
  try {
    // Parse query parameters
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
 ...
 */
export const getHotelIncomeReport = async (req, res, next) => {
  try {
 ...
 */
export const getBranchwiseIncome = async (req, res, next) => {
  try {
    const { hotelId } = req.params;
