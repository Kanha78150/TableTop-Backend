 ...
 * @access Staff
 */
export const getFoodCategories = asyncHandler(async (req, res, next) => {
 ...
 * @access Staff
 */
export const getFoodItems = asyncHandler(async (req, res, next) => {
  const staffId = req.user._id;
  const {
    page = 1,
    limit = 20,
 ...
 * @access Staff
 */
export const getItemsByCategory = asyncHandler(async (req, res, next) => {
  const { categoryId } = req.params;
  const {
    page = 1,
    limit = 20,
 ...
 * @access Staff
 */
export const searchMenuItems = asyncHandler(async (req, res, next) => {
  const {
    query: searchQuery,
    page = 1,
    limit = 20,
