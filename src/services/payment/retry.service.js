...
class PaymentRetryService {
  ...
  startRetryJobs() {
    ...
    // Job 4: Mark long-pending payments as failed (runs every 5 minutes)
  ...
  async markLongPendingPaymentsAsFailed() {
    try {
      ...
      // Find payments pending for more than 5 minutes (payment window expired)
        ...
        },
        {
          ...
          $push: {
            paymentHistory: {
              ...
              status: "failed",
              notes:
                "Payment timeout - automatically cancelled after 5 minutes",
            },
          },
        }
      );
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            <ul style="list-style: none; padding: 0;">
              ...
              <li>Amount: ₹${paymentOrder.amount}</li>
            </ul>
          </div>
      ...
      const emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p style="color: #666; font-size: 12px; font-style: italic;">
            Note: Pending payments will be automatically cancelled after 5 minutes.
          </p>
        </div>
      `;
